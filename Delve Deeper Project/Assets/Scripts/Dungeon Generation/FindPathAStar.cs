...
public class FindPathAStar : MonoBehaviour
{
    ...
    void BeginSearch()
    {
        ...
        Vector3 startLoc = new Vector3(locations[0].x * maze.scale, 0, locations[0].z * maze.scale);
        startNode = new PathMarker(new MapLocation(locations[0].x, locations[0].z), 0, 0, 0, null);

        Vector3 endLoc = new Vector3(locations[1].x * maze.scale, 0, locations[1].z * maze.scale);
        endNode = new PathMarker(new MapLocation(locations[1].x, locations[1].z), 0, 0, 0, null);
    ...
    void NewSearch(PathMarker thisNode)
    {
        if (thisNode.Equals(endNode)) { done = true; return; }
